...
def do_zip_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("9/11 SMS BOMBER was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update 9/11 SMS BOMBER.")
...
def check_for_updates():
    mesgdcrt.SectionMessage("Checking for better planes to crash")
    fver = requests.get(
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("9/11 SMS BOMBER is up-to-date")
        mesgdcrt.GeneralMessage("Starting 9/11 SMS BOMBER")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SectionMessage("Planes are ramming the twin towers is in progress - Please be patient")
    mesgdcrt.GeneralMessage(
    ...
    mesgdcrt.SuccessMessage("9/11 SMS Bomber was made by japan#4388")

    mesgdcrt.SuccessMessage("mellys poop flavour changes every day")
    
    mesgdcrt.SuccessMessage("louis anals dolls are Miku Mikasa Touka Yamauchi and Haku")

    mesgdcrt.SuccessMessage("allah it has hit alahhhugbar the plane has hit the towers sending more in now")
...
def workernode(mode, cc, target, count, delay, max_threads):
    ...
    print("\n")
    mesgdcrt.SuccessMessage("Twin Towers Have Been hit (it was a sucess)")
    time.sleep(1.5)
    bann_text()
    sys.exit()
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("9/11 SMS BOMBER will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['japan#4388', 'melly b)', 'louis' ]

ALL_COLORS = [Fore.GREEN, Fore.RED, Fore.YELLOW, Fore.BLUE,
              Fore.MAGENTA, Fore.CYAN, Fore.WHITE]
RESET_ALL = Style.RESET_ALL

description = """9/11 SMS BOMBER - Your Friendly Spammer Application

9/11 SMS BOMBER  can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

9/11 SMS BOMBER is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by japan#4388 !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start 9/11 SMS BOMBER with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start 9/11 SMS BOMBER with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start 9/11 SMS BOMBER with MAIL Bomb mode")
parser.add_argument("-u", "--update", action="store_true",
                    help="update 9/11 SMS BOMBER")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current 9/11 SMS BOMBER contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current 9/11 SMS BOMBER version")
